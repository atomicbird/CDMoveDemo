...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    lazy var backupURL: URL = {
        ...
        let destinationDirectoryURL = appSupportDirectory.appendingPathComponent("copy")
    ...
    func configureCell(_ cell: UITableViewCell, withEvent event: Event) {
        let lastPathComponent = event.objectID.uriRepresentation().lastPathComponent
        print("\(lastPathComponent)")
        cell.textLabel!.text = "\(lastPathComponent): \(event.timestamp!.description)"
    }
